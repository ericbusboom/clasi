...
- [ ] `tests/e2e/README.md` exists with purpose, prerequisites, file descriptions, usage instructions
- [ ] README explains how to add new e2e tests
- [ ] README notes cost/timing considerations
- [ ] TODO file `docs/clasi/todo/done/e2e-guessing-game-test.md` exists with done status
- [ ] TODO frontmatter references sprint 024
