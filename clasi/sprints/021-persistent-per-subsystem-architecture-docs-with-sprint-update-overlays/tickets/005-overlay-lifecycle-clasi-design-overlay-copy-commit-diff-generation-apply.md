...
- [ ] Seed step: given a list of canonical doc paths and a sprint
...
- [ ] Diff step: given a sprint's `design/` directory, for each `.md` file
      ...
      ticket 004).
- [ ] Diff step correctly identifies "pristine" as the state at the seed
...
- [ ] Apply step: copies each sprint overlay `.md` file (excluding
      ...
      issue).
- [ ] Apply step raises a clear, typed error without partially applying
...
- [ ] All git operations follow the existing inline-`subprocess.run`
