---
id: "012"
title: "close_sprint auto-detect sprint_id from git branch"
status: roadmap
branch: sprint/012-close-sprint-auto-detect-sprint-id-from-git-branch
use-cases: []
issues: []
---
<!-- CLASI: Before changing code or making plans, review the SE process in CLAUDE.md -->

# Sprint 012: close_sprint auto-detect sprint_id from git branch
